...
import com.github.yingzhuo.carnival.restful.security.RequiresAnyPermission;
 ...
 * @since 1.1.7
 */
public class RequiresAnyPermissionAuthComponent implements AuthenticationComponent<RequiresAnyPermission> {

    @Override
    public void authenticate(Token token, UserDetails userDetails, RequiresAnyPermission annotation) throws RestfulSecurityException {
        if (userDetails == null) {
