...
import com.github.yingzhuo.carnival.restful.security.RequiresAllPermissions;
 ...
 * @since 1.1.7
 */
public class RequiresAllPermissionsAuthComponent implements AuthenticationComponent<RequiresAllPermissions> {

    @Override
    public void authenticate(Token token, UserDetails userDetails, RequiresAllPermissions annotation) throws RestfulSecurityException {
        if (userDetails == null) {
        ...
        final Set<String> actual = new HashSet<>(userDetails.getPermissionNames());
