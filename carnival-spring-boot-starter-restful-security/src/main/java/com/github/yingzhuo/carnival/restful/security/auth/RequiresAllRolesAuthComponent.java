...
import com.github.yingzhuo.carnival.restful.security.RequiresAllRoles;
 ...
 * @since 1.1.7
 */
public class RequiresAllRolesAuthComponent implements AuthenticationComponent<RequiresAllRoles> {

    @Override
    public void authenticate(Token token, UserDetails userDetails, RequiresAllRoles annotation) throws RestfulSecurityException {
        if (userDetails == null) {
