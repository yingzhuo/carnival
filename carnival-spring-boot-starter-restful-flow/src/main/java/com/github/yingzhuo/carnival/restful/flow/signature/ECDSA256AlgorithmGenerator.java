 ...
 * @since 1.6.1
 */
class ECDSA256AlgorithmGenerator extends AbstractECDSAAlgorithmGenerator {

    private final String publicKey;
    private final String privateKey;

    public ECDSA256AlgorithmGenerator(String publicKey, String privateKey) {
        this.publicKey = Objects.requireNonNull(publicKey);
        this.privateKey = Objects.requireNonNull(privateKey);
    }

    public ECDSA256AlgorithmGenerator(ResourceText publicKey, ResourceText privateKey) {
