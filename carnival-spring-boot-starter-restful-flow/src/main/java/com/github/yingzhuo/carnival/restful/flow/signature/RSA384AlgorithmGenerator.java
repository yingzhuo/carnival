 ...
 * @since 1.6.1
 */
class RSA384AlgorithmGenerator extends AbstractRSAAlgorithmGenerator {

    private final String publicKey;
    private final String privateKey;

    public RSA384AlgorithmGenerator(String publicKey, String privateKey) {
        this.publicKey = Objects.requireNonNull(publicKey);
        this.privateKey = Objects.requireNonNull(privateKey);
    }

    public RSA384AlgorithmGenerator(ResourceText publicKey, ResourceText privateKey) {
