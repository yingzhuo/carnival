 ...
 * @author 应卓
 */
public class FutureLimitedConstraintValidator implements ConstraintValidator<FutureLimited, Date> {

    private FutureLimited annotation;
    ...
    @Override
    public void initialize(FutureLimited constraintAnnotation) {
