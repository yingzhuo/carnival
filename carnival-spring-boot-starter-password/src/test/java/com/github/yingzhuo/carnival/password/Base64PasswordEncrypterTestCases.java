...
import com.github.yingzhuo.carnival.password.impl.Base64PasswordEncrypter;
import com.github.yingzhuo.carnival.password.impl.RepeatPasswordEncrypter;
import org.junit.Test;
import org.springframework.util.Assert;

public class Base64PasswordEncrypterTestCases {
    ...
    public void testInstance() {
        final PasswordEncrypter encrypter = new Base64PasswordEncrypter();
    ...
    public void testInstanceWithRepeat() {
        final PasswordEncrypter encrypter = new RepeatPasswordEncrypter(new Base64PasswordEncrypter(), 3);
