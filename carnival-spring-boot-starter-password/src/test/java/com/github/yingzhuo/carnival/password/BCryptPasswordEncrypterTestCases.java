...
public class BCryptPasswordEncrypterTestCases {
    ...
    public void testInstance() {
        final PasswordEncrypter encrypter = new BCryptPasswordEncrypter();
    ...
    public void testInstanceWithRepeat() {
        final PasswordEncrypter encrypter = new RepeatPasswordEncrypter(new BCryptPasswordEncrypter(), 3);
