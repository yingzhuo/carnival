...
import static external.Util.checkArgument;
import static external.Util.checkNotNull;


@ThreadSafe
public class Subscriber extends BasePubSub {

    private final List<HostAndPort> lookups = new ArrayList<>();
    ...
    protected Set<HostAndPort> lookupTopic(String topic) {
        Set<HostAndPort> nsqds = new HashSet<>();
